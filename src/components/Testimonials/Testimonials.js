...
const Testimonials = () => (
  <div className="container--testimonial">
          ...
          <ul className="featured__list">
            <li className="featured__list-item">
              ...
              <div className="testimonial__wrapper">
                ...
                <p className="testimonial--text font-light">
                  “This is a no nonsense treatment center, I have learned a lot
                  here.”
                </p>
              </div>
            </li>
    ...
    <div className="container--ruler">
      <div className="testimonial__content">
        <div className="testimonial__content--title font-heavy">
          Testimonials
        </div>
        <ul className="testimonial__list">
          <li className="testimonial__list-item">
            ...
            <img src={FourStar} className="star-review" />
            <div className="testimonial__wrapper">
              <h3 className="testimonial--title font-heavy">Nicholas Foster</h3>
              <p className="testimonial--date font-light">December 12, 2016</p>
              <p className="testimonial--text font-light">
                "Accommodations and staff are excellent, I greatly benefited
                from the completion of this program."
              </p>
            </div>
          </li>
          <li className="testimonial__list-item">
            ...
            <div className="testimonial__wrapper">
              ...
              <p className="testimonial--text font-light">
                “The staff at LTH are amazing people. They definitely made the
                experience nice for me, thank you.”
              </p>
            </div>
          </li>
          <li className="testimonial__list-item">
            ...
            <div className="testimonial__wrapper">
              ...
              <p className="testimonial--text font-light">
                “My is experience here was great and the staff is willing to
                help when ever needed.”
              </p>
            </div>
          </li>
        </ul>
