...
const Form = () => (
  <div className="bg-grey-100 pin-form lg:w-1/4 xl:w-1/5">
    <div className="m-auto container text-center py-40 lg:py-20 px-10">
      ...
      >
        ...
        <input
          className="mb-10 px-40 py-10 font-300 text-18 bg-grey-100 text-navy border-navy
         border-2 rounded-full"
          type="submit"
          value="Contact Me"
        />
      </form>
      <div className="mt-5 pb-20 text-18 font-400 text-grey-500">
        Insurance Accepted. Privacy Guaranteed.
      </div>
      <div className="text-grey-500 text-14 font-300 leading-normal md:m-auto md:w-1/2 lg:w-auto">
