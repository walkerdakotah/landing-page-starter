    ...
    <div className="container--ruler">
      <div className="form__content">
        <div className="form__header">
          <div className="form__title font-grey font-medium">
            Call 24/7, 365 Days a Year:
          </div>
          <div className="form__cta font-teal">
            <a href={`tel:+1${config.CALLRAIL.PHONE}`}>
              <div className="form__cta--phone font-heavy">
                Call {config.CALLRAIL.PHONE}
              </div>
            </a>
            <div className="form__cta--tease font-heavy">
        ...
        <div className="form__body">
          ...
          >
            ...
            <input
              name="retURL"
              type="hidden"
              value={`https://${config.SITE.NAME}/thank-you-2/`}
            />
            <input
              id="lead_source"
              name="lead_source"
        ...
        <div className="form__footer">
          <div className="form__cta--guarantee font-grey font-medium">
            Insurance Accepted. Privacy Guaranteed.
          </div>
          <ul className="font-light form__footer--list">
            <li className="font-medium form__footer--list-item search">
              FREE Insurance Verification
            </li>
            <li className="font-medium form__footer--list-item clock">
              Help Available 24/7
            </li>
          </ul>
          <div className="form__footer--disclaimer font-medium">
            By submitting this form, I agree to be contacted by American
            Addiction Centers, Inc. at the phone number provided above,
            including my wireless numbers if provided. We won’t sell your
            information and will treat your information in accordance with our{' '}
            <a
              href={`https://${config.SITE.NAME}/${config.SITE.POLICY_LINK}/`}
              target="_blank"
              alt="Privacy Policy"
            >
              privacy policy
