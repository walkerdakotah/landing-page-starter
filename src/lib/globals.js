// General AAC Corporate Phone Number
export const phoneNumber = '(888) 987-1784';
export const phoneNumberLink = 'tel:+1-888-987-1784';

// Links to AAC Corporate Policies and Terms
export const onlinePolicy = 'https://americanaddictioncenters.org/policy/';
