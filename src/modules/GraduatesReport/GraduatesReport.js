...
const GraduatesReport = () => (
  <div className="m-auto container pt-40 lg:pt-80">
    ...
    <ul className="list-reset flex flex-col items-center lg:flex-row">
      <li className="mb-40 lg:px-20 flex flex-col items-center w-56 lg:w-1/3 lg:border-r">
        <div className="w-40 lg:w-56 my-10 flex-none">
          <img src={Number44} alt="44 percent" />
        </div>
        <div className="text-center">
          <p className="text-18 lg:text-26 font-500 text-grey-500 leading-normal lg:leading-tight">
      ...
      <li className="mb-40 lg:px-20 flex flex-col items-center w-56 lg:w-1/3">
        <div className="w-40 lg:w-56 my-10 flex-none">
